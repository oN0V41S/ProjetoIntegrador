...
export default function Footer(){
  ...
  <footer id="footer" class="py-14 bg-[#000]">
    <div id="fundo" class="flex flex-col justify-around items-center text-white w-10/12 bg-[#202020] m-auto text-xl mt-6 p-6">
      ...
      <div id="avatar-container" class="grid grid-cols-1 md:grid-cols-5 items-center justify-between">
...
export function Devs({name, github, linkedin, avatar}){
    return(
        <div id="avatar" class="flex flex-col items-center m-auto gap-4 w-max mb-8 md:mb-2">
          <img class="w-18 md:w-32 " src={avatar} alt="avatar"/>
