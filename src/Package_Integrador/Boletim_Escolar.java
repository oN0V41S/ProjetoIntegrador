...
public class Boletim_Escolar {
	...
	static int MaiorMedia;
	static int MenorMedia;
	...
	public static void main (String[] args) {
		...
		for (int i = 0; i < 5; i++) {
		    ...
		    updateMinMaxMedia(alunos.get(i).getMedia(), i);
		    updateMelhorAluno(alunos.get(i), i);
		}
		...
		System.out.println("Aluno com a Maior Media: " + MaiorMedia);
		System.out.println("Aluno com a Menor Media: " + MenorMedia);
	...
	private static void updateMinMaxMedia(float media, int index) {
	    if (index == 0) {
	        MaiorMedia = (int) media;
	        MenorMedia = (int) media;
	    }
	...
	private static void updateMelhorAluno(Aluno aluno, int index) {
	...
	private static String getNomeInput() throws Validacao {
        ...
        try {
            ...
            throw new Validacao("Um erro inesperado ocorreu.");		
        }
    }
	...
	public static void salvarProduto() {
		...
		try (BufferedWriter escrever = new BufferedWriter(new FileWriter("C:\\Users\\CT Desenvolvimento\\Documents\\boletimPI.txt", true))) {
        	...
        	escrever.newLine();
        	escrever.write("Aluno com a Maior Media: " + MaiorMedia);
        	escrever.newLine();
        	escrever.write("Aluno com a Menor Media: " + MenorMedia);
        	escrever.newLine();
